...
@testset "Floor etc. tests" begin
    ...
    @test round(@interval(0.1, 1.1), digits=RoundTiesToEven) == Interval(0.0, 1.0)
    @test round(@interval(0.1, 1.5), digits=RoundTiesToEven) == Interval(0.0, 2.0)
    @test round(@interval(-1.5, 0.1), digits=RoundTiesToEven) == Interval(-2.0, 0.0)
    @test round(@interval(-2.5, 0.1), digits=RoundTiesToEven) == Interval(-2.0, 0.0)
    @test round(@interval(0.1, 1.1), digits=RoundTiesToAway) == Interval(0.0, 1.0)
    @test round(@interval(0.1, 1.5), digits=RoundTiesToAway) == Interval(0.0, 2.0)
    @test round(@interval(-1.5, 0.1), digits=RoundTiesToAway) == Interval(-2.0, 0.0)
    @test round(@interval(-2.5, 0.1), digits=RoundTiesToAway) == Interval(-3.0, 0.0)
